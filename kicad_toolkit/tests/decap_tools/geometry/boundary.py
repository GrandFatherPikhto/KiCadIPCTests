...
# Скопировано из KiCadDecapPlacer (kicad_toolkit/tests/decap_tools/geometry/,
# 2026-07-14) — кандидат на будущую консолидацию в общее место, раз это
# используется больше чем одним проектом. Пока — осознанный дубль.
...
class GeometryError(Exception):
    """Локальная копия decap_placer.exceptions.GeometryError."""
    pass
